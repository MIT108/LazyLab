                ...
                <div class="modal-content">
                    <form action="/create-offer" method="POST">
                        ...
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Input offer informations</h5>
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="price" id="name-name">
                            </div>
                        </div>
                        <div class="modal-body">
                            <div class="form-group">
                        ...
                        <div class="d-flex flex-row justify-content-between">
                            ...
                            <div class="col-4">
                                ...
                                <a type="button" class="btn bg-gradient-success btn-block mb-3" data-bs-toggle="modal"
                                    data-bs-target="#exampleModalMessage">+&nbsp; New Offer</a>
                            </div>
                                ...
                                <tbody>
                                    @foreach ($offers as $offer)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <p class="text-xs font-weight-bold mb-0">{{ $offer->created_at }}</p>
                                            </td>
                                            <td class="text-center">
                                                <a href="/view-offer/{{ $offer->id }}" class="mx-3"
                                                    data-bs-toggle="tooltip" data-bs-original-title="View offer">
                                                    <i class="cursor-pointer fas fa-eye text-secondary"></i>
                                                </a>
                                                <a href="/offer/delete/{{ $offer->id }}" class="mx-3"
                                                    data-bs-toggle="tooltip" data-bs-original-title="Delete offer">
